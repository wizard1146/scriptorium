...
| `page__title` | The page's `<h1>`, from the `title:` metadata. Scrolls with the page, then pins just below the `site-header` (only on windows taller than 32rem) | template |

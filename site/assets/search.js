...
(() => {
  ...
  input.addEventListener('input', async () => {
    ...
    list.innerHTML = hits.slice(0, 12).map(h =>
      `<li class="search-result"><a class="search-result__link" href="${h.d.u}"><span class="search-result__title">${esc(h.d.t)}</span><span class="search-result__snippet">${esc(h.snippet)}</span></a></li>`
